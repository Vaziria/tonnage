...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Tonnage Core tonnage-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tonnage-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tonnage transaction") + "\n" +
              "  tonnage-tx [options] -create [commands]   " + _("Create hex-encoded tonnage transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tonnage transaction
