...
#define BOOST_TEST_MODULE Tonnage Test Suite

#include "test_tonnage.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_tonnage_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
