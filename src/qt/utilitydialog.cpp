    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Tonnage Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Tonnage Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  tonnage-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Tonnage in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 TNN, 0.1 TNN, 1 TNN and 10 TNN -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Tonnage Core is shutting down...") + "<br /><br />" +
