...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "TonnageNetwork") type = TonnageNetwork;
    if(strType == "TonnageNetworkVariable") type = TonnageNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == TonnageNetwork) s = "TonnageNetwork";
    if(type == TonnageNetworkVariable) s = "TonnageNetworkVariable";
