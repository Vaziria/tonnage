...
This mechanism has been integrated into Bitcore-Node-Tonnage which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TonnageOfficial/insight-api-tonnage#web-socket-api](https://github.com/TonnageOfficial/insight-api-tonnage#web-socket-api)
* API: [https://github.com/TonnageOfficial/insight-api-tonnage#instantsend-transactions](https://github.com/TonnageOfficial/insight-api-tonnage#instantsend-transactions)
...
By default, the Tonnage Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Tonnage Core daemon:
