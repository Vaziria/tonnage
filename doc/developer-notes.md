...
Tonnage Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Tonnage Core, where everyone uses
...
pay attention to for reviewers of Tonnage Core code.

General Tonnage Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Tonnage Core uses tinyformat, which is type safe. Leave them out to avoid confusion
