...
Only requiring some minor changes is tonnage.cpp.
...
Changes to tonnage.cpp
----------------------
tonnage.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
